const abi = [
  {
    inputs: [
      { internalType: 'address', name: '_auctionOwner', type: 'address' },
      { internalType: 'uint256', name: '_listingFee', type: 'uint256' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'bool', name: 'started', type: 'bool' },
    ],
    name: 'AuctionStatus',
    type: 'event',
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'bool', name: 'listedForAuction', type: 'bool' },
      { internalType: 'bool', name: 'isAuctioning', type: 'bool' },
      { internalType: 'address', name: 'seller', type: 'address' },
      { internalType: 'address', name: 'owner', type: 'address' },
      { internalType: 'address', name: 'bidLeader', type: 'address' },
    ],
